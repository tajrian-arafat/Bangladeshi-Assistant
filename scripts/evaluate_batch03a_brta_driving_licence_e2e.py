#!/usr/bin/env python3
"""Batch 3A BRTA driving licence end-to-end evaluation (local/dev only)."""
...
from batch03a_eval_outcomes import BRTA_DRIVING_LICENCE_FAMILY, evaluate_batch03a_outcome  # noqa: E402

OUT_DIR = REPO_ROOT / "data/evaluation/batch-03a-brta-driving-licence"
...
def evaluate_case(case: dict, actual: dict) -> dict[str, Any]:
    ...
    outcome = evaluate_batch03a_outcome(case, actual, {"reasons": reasons, "checks": checks})
