#!/usr/bin/env python3
"""Batch 3B BRTA vehicle end-to-end evaluation (local/dev only)."""
...
from batch03b_eval_outcomes import BRTA_VEHICLE_FAMILY, evaluate_batch03b_outcome  # noqa: E402

OUT_DIR = REPO_ROOT / "data/evaluation/batch-03b-brta-vehicle"
...
def evaluate_case(case: dict, actual: dict) -> dict[str, Any]:
    ...
    outcome = evaluate_batch03b_outcome(case, actual, {"reasons": reasons, "checks": checks})
