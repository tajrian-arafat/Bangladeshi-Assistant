...
**Run ID:** run-b05a68e7c01a-verification
...
- `.automation/runs/run-b05a68e7c01a-verification/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-b05a68e7c01a-verification",
  "service_ids": [
    "agri-bamis-farmer-registration",
    "agri-dae-district-extension",
    "agri-e-pesticide-prescription",
...
Write machine-readable `.automation/runs/run-b05a68e7c01a-verification/result.json` when complete.
