...
**Run ID:** run-db5a383e19c6-gap_closure
...
- `.automation/runs/run-db5a383e19c6-gap_closure/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-db5a383e19c6-gap_closure",
  "service_ids": [
    "disability-dis-registration",
    "ff-g2p-electronic-payment",
    "ff-honorarium-allowance",
...
Write machine-readable `.automation/runs/run-db5a383e19c6-gap_closure/result.json` when complete.
