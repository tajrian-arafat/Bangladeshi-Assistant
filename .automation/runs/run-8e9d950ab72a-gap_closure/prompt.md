...
**Run ID:** run-8e9d950ab72a-gap_closure
...
- `.automation/runs/run-8e9d950ab72a-gap_closure/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-8e9d950ab72a-gap_closure",
  "service_ids": [
    "land-deed-registration",
    "land-dlrms-application-track",
    "land-khatian-certified-copy",
...
Write machine-readable `.automation/runs/run-8e9d950ab72a-gap_closure/result.json` when complete.
