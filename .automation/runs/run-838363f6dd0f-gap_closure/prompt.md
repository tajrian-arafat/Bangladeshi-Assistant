...
**Run ID:** run-838363f6dd0f-gap_closure
...
- `.automation/runs/run-838363f6dd0f-gap_closure/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-838363f6dd0f-gap_closure",
  "service_ids": [
    "judiciary-case-status-tracking",
    "judiciary-supreme-court-certified-copy",
    "judiciary-supreme-court-e-filing",
...
Write machine-readable `.automation/runs/run-838363f6dd0f-gap_closure/result.json` when complete.
