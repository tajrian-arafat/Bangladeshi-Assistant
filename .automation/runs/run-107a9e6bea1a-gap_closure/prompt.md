...
**Run ID:** run-107a9e6bea1a-gap_closure
...
- `.automation/runs/run-107a9e6bea1a-gap_closure/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-107a9e6bea1a-gap_closure",
  "service_ids": [
    "employment-boesl-overseas-recruitment",
    "employment-labour-court-adr",
    "employment-trade-union-registration",
...
Write machine-readable `.automation/runs/run-107a9e6bea1a-gap_closure/result.json` when complete.
