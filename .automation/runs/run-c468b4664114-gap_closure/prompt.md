...
**Run ID:** run-c468b4664114-gap_closure
...
- `.automation/runs/run-c468b4664114-gap_closure/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-c468b4664114-gap_closure",
  "service_ids": [
    "bida-aftercare-services",
    "bida-commercial-office-services",
    "bida-invest-bangladesh-oss",
...
Write machine-readable `.automation/runs/run-c468b4664114-gap_closure/result.json` when complete.
