...
## Required outputs
- `data/evaluation/batch-05-land/queries.json`
- `data/evaluation/batch-05-land/summary.json`
- `docs/evaluation/batch-05-land-publication-e2e.md`
- `.automation/runs/run-8e9d950ab72a-e2e/result.json`
...
Write machine-readable `.automation/runs/run-8e9d950ab72a-e2e/result.json` when complete.
