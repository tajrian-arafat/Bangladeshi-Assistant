...
## Required outputs
- `data/evaluation/batch-09-agriculture/queries.json`
- `data/evaluation/batch-09-agriculture/summary.json`
- `docs/evaluation/batch-09-agriculture-publication-e2e.md`
- `.automation/runs/run-b05a68e7c01a-e2e/result.json`
...
Write machine-readable `.automation/runs/run-b05a68e7c01a-e2e/result.json` when complete.
