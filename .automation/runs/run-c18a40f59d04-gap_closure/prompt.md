...
**Run ID:** run-c18a40f59d04-gap_closure
...
- `.automation/runs/run-c18a40f59d04-gap_closure/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-c18a40f59d04-gap_closure",
  "service_ids": [
    "bpdb-high-tension-connection",
    "bpdb-new-connection-general",
    "bpdb-online-bill",
...
Write machine-readable `.automation/runs/run-c18a40f59d04-gap_closure/result.json` when complete.
