...
**Run ID:** run-c18a40f59d04-verification
...
## Required outputs
- `data/research/verification/batch-14-remaining/claims_verification.json`
- `data/research/verification/batch-14-remaining/summary.json`
- `.automation/runs/run-c18a40f59d04-verification/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-c18a40f59d04-verification",
  "service_ids": [
    "bpdb-high-tension-connection",
    "bpdb-new-connection-general",
    "bpdb-online-bill",
...
Write machine-readable `.automation/runs/run-c18a40f59d04-verification/result.json` when complete.
