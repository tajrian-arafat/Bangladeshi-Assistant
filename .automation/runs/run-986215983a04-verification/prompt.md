...
**Run ID:** run-986215983a04-verification
...
- `.automation/runs/run-986215983a04-verification/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-986215983a04-verification",
  "service_ids": [
    "dc-attestation-photocopy",
    "dc-citizen-charter-bagerhat",
    "dc-citizen-charter-comilla",
...
Write machine-readable `.automation/runs/run-986215983a04-verification/result.json` when complete.
