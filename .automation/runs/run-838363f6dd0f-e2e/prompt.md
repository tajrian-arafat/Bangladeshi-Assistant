...
## Required outputs
- `data/evaluation/batch-13-judiciary/queries.json`
- `data/evaluation/batch-13-judiciary/summary.json`
- `docs/evaluation/batch-13-judiciary-publication-e2e.md`
- `.automation/runs/run-838363f6dd0f-e2e/result.json`
...
Write machine-readable `.automation/runs/run-838363f6dd0f-e2e/result.json` when complete.
