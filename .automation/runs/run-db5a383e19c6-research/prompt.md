...
**Run ID:** run-db5a383e19c6-research
...
## Required outputs
- `data/research/raw/batch-08-social-protection/scope.json`
- `data/research/raw/batch-08-social-protection/services_index.json`
- `data/research/raw/batch-08-social-protection/services/*.json`
- `data/research/raw/batch-08-social-protection/claims.json`
- `data/research/raw/batch-08-social-protection/sources.json`
- `data/research/raw/batch-08-social-protection/conflicts.json`
- `data/research/raw/batch-08-social-protection/knowledge_gaps.json`
- `data/research/raw/batch-08-social-protection/metadata.json`
- `docs/research/batch-08-social-protection-research.md`
- `.automation/runs/run-db5a383e19c6-research/result.json`
...
```json
{
  ...
  "phase": "RESEARCH",
  "run_id": "run-db5a383e19c6-research",
  "service_ids": [
    "disability-dis-registration",
    "ff-g2p-electronic-payment",
    "ff-honorarium-allowance",
...
Write machine-readable `.automation/runs/run-db5a383e19c6-research/result.json` when complete.
