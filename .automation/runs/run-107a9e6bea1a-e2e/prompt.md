...
## Required outputs
- `data/evaluation/batch-10-employment-migration/queries.json`
- `data/evaluation/batch-10-employment-migration/summary.json`
- `docs/evaluation/batch-10-employment-migration-publication-e2e.md`
- `.automation/runs/run-107a9e6bea1a-e2e/result.json`
...
Write machine-readable `.automation/runs/run-107a9e6bea1a-e2e/result.json` when complete.
