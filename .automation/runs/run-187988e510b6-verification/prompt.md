...
**Run ID:** run-187988e510b6-verification
...
## Required outputs
- `data/research/verification/batch-07-health/claims_verification.json`
- `data/research/verification/batch-07-health/summary.json`
- `.automation/runs/run-187988e510b6-verification/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-187988e510b6-verification",
  "service_ids": [
    "health-16263-telemedicine",
    "health-blood-bank-license",
    "health-bmdc-additional-qualification",
...
Write machine-readable `.automation/runs/run-187988e510b6-verification/result.json` when complete.
