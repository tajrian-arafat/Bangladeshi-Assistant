...
**Run ID:** run-187988e510b6-gap_closure
...
- `.automation/runs/run-187988e510b6-gap_closure/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-187988e510b6-gap_closure",
  "service_ids": [
    "health-16263-telemedicine",
    "health-blood-bank-license",
    "health-bmdc-additional-qualification",
...
Write machine-readable `.automation/runs/run-187988e510b6-gap_closure/result.json` when complete.
