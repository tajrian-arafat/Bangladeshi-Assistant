...
**Run ID:** run-c468b4664114-verification
...
## Required outputs
- `data/research/verification/batch-11-business-trade/claims_verification.json`
- `data/research/verification/batch-11-business-trade/summary.json`
- `.automation/runs/run-c468b4664114-verification/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-c468b4664114-verification",
  "service_ids": [
    "bida-aftercare-services",
    "bida-commercial-office-services",
    "bida-invest-bangladesh-oss",
...
Write machine-readable `.automation/runs/run-c468b4664114-verification/result.json` when complete.
