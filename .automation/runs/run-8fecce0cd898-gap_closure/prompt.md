...
**Run ID:** run-8fecce0cd898-gap_closure
...
- `.automation/runs/run-8fecce0cd898-gap_closure/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-8fecce0cd898-gap_closure",
  "service_ids": [
    "education-class-registration",
    "education-duplicate-certificate",
    "education-foreign-enrollment-permission",
...
Write machine-readable `.automation/runs/run-8fecce0cd898-gap_closure/result.json` when complete.
