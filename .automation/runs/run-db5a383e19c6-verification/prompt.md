...
**Run ID:** run-db5a383e19c6-verification
...
## Required outputs
- `data/research/verification/batch-08-social-protection/claims_verification.json`
- `data/research/verification/batch-08-social-protection/summary.json`
- `.automation/runs/run-db5a383e19c6-verification/result.json`
...
```json
{
  ...
  "phase": "VERIFICATION",
  "run_id": "run-db5a383e19c6-verification",
  "service_ids": [
    "disability-dis-registration",
    "ff-g2p-electronic-payment",
    "ff-honorarium-allowance",
...
Write machine-readable `.automation/runs/run-db5a383e19c6-verification/result.json` when complete.
